...
The first part of the chapter describes the experimental study which motivated making a model for \name{Pseudotime}. After the results, we will go in depth into presenting the models we are using, in the context of single cell gene expression.
