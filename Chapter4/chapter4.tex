...
\section{Assessment of \name{GPfates} on simulated and real data}
...
\begin{figure}
    ...
    \caption{Summary of \name{GPfates} result of Treutlein et al developing lung data.}
    \label{fig:treutlein}
\end{figure}
...
\begin{figure}
    ...
    \caption{Summary of \name{GPfates} result of Guo et al developing primordial germ cell data.}
    \label{fig:guo}
\end{figure}
...
\begin{figure}
    ...
    \caption{Summary of \name{GPfates} result of Owens et al developing frog embryo data.}
    \label{fig:owens}
\end{figure}
